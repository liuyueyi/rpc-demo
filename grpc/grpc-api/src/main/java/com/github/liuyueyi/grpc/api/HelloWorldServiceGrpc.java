...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.github.liuyueyi.grpc.api.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.github.liuyueyi.grpc.api.Person,
      com.github.liuyueyi.grpc.api.Greeting> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.github.liuyueyi.grpc.api.Person.class,
      responseType = com.github.liuyueyi.grpc.api.Greeting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.github.liuyueyi.grpc.api.Person,
      com.github.liuyueyi.grpc.api.Greeting> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.github.liuyueyi.grpc.api.Person, com.github.liuyueyi.grpc.api.Greeting> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.github.liuyueyi.grpc.api.Person, com.github.liuyueyi.grpc.api.Greeting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.liuyueyi.grpc.api.Person.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.liuyueyi.grpc.api.Greeting.getDefaultInstance()))
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.github.liuyueyi.grpc.api.Person request,
        io.grpc.stub.StreamObserver<com.github.liuyueyi.grpc.api.Greeting> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.github.liuyueyi.grpc.api.Person,
                com.github.liuyueyi.grpc.api.Greeting>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public com.github.liuyueyi.grpc.api.Greeting sayHello(com.github.liuyueyi.grpc.api.Person request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.github.liuyueyi.grpc.api.Greeting> sayHello(
        com.github.liuyueyi.grpc.api.Person request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.github.liuyueyi.grpc.api.Person) request,
              (io.grpc.stub.StreamObserver<com.github.liuyueyi.grpc.api.Greeting>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.github.liuyueyi.grpc.api.HelloWorld.getDescriptor();
    }
